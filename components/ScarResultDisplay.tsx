...
export const ScarResultDisplay: React.FC<ScarResultDisplayProps> = ({ result, editablePlan, onPlanChange, availableMachines, availableCosmetics }) => {
    ...
    return (
        <div className="animate-fade-in space-y-6">
            ...
            {/* Treatment Plan Card */}
            <div className="p-5 bg-white border border-slate-200 rounded-2xl">
                <h3 className="text-xl font-bold text-slate-800 mb-4">Phác đồ điều trị sẹo (Có thể chỉnh sửa)</h3>
                <div className="space-y-3">
                    <AccordionSection
            ...
            <div className="p-5 bg-white border border-slate-200 rounded-2xl">
                <h3 className="text-xl font-bold text-slate-800 mb-4">Lộ trình & Kết quả dự kiến (Có thể chỉnh sửa)</h3>
                <div className="space-y-4">
                     <EditableTextField
